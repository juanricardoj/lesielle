...
class ConnectorSnippet(models.TransientModel):
    ...
    def create_odoo_connector_mapping(self, model, ecomm_id, odoo_id, instance_id, **kwargs):
        ...
        if 'created_by' in kwargs:
            if hasattr(self, 'create_%s_connector_odoo_mapping' % kwargs['created_by']):
                mapping_data = getattr(self, 'create_%s_connector_odoo_mapping' % kwargs['created_by'])(mapping_data)
